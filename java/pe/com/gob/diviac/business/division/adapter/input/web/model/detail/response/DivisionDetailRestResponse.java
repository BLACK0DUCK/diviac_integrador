package pe.com.gob.diviac.business.division.adapter.input.web.model.detail.response;
...
@Getter
@Setter
@Schema(name = "DivisionDetailResponseBusiness")
public class DivisionDetailRestResponse extends DivisionRestResponse {

    @Builder
    public DivisionDetailRestResponse(UUID id, String code, String acronym, String name, String description,
